...
if (varX < varB) {
    console.log(`${varX} is equal to varX`)
}
...
if (varY === varZ) {
//      code to be executed;
     console.log(`The first conditional statement is TRUE, so this code executed.`)
} else {
//      code to be executed;
     console.log(`The first statement is false.`)
};
...
console.log(`The variable yourAge is: ${theirAge} and it's a: ${typeof theirAge}`);
